...
import { ArrowRightUpIcon, DidIcon, DiscordIcon, DotbitTextIcon, SoulFragIcon, SubscriptionIcon, TwitterIcon, VotyFirstLetterIcon, VotyIcon } from "./icons"
...
export default function Footer(props: {
  ...
  return (
    <footer
      ...
      <div
        className="mx-auto w-full max-w-7xl px-3 pb-[60px] pt-16 md:px-6 lg:px-8">
        <div
          ...
          <div
            ...
            <Link 
              ...
              <h1>
                <VotyIcon 
                  className="h-[25px] text-primary-500 transition group-hover:text-primary-600" />
              </h1>
            </Link>
        ...
        <div
          className="mt-[100px] flex flex-col-reverse items-center gap-6 lg:flex-row lg:justify-between">
          <div
            className="text-sm font-medium text-footer-color">
