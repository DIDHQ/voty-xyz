...
>(function TextInput(props, ref) {
  ...
  return (
    <input
      ...
      {...restProps}
      className={clsx(
        'block w-full rounded border placeholder:text-gray-400 disabled:cursor-not-allowed disabled:border-gray-200 disabled:bg-gray-50 disabled:text-gray-500 sm:text-sm',
        error
