...
export default function CommunityCard(props: {
  ...
  return (
    <Link
      ...
      className="block overflow-hidden rounded border border-gray-200 p-6 transition-colors focus-within:ring-2 focus-within:ring-primary-500 focus-within:ring-offset-2 hover:border-primary-400"
    >
