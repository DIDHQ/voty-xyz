  ...
  return (
    <div className={clsx('relative', props.className)}>
      <input
        ...
        className={clsx(
          'block w-full border pl-4 pr-24 disabled:cursor-not-allowed disabled:border-gray-200 disabled:bg-gray-50 disabled:text-gray-500 sm:text-sm',
          props.error
      ...
      <div className="absolute inset-y-0 right-0 flex items-center">
        <select
          ...
          onBlur={handleBlur}
          disabled={props.disabled}
          className="h-full border-transparent bg-transparent py-0 pl-2 pr-7 text-gray-500 focus:border-primary-500 focus:ring-primary-500 disabled:cursor-not-allowed sm:text-sm"
        >
